...
void lab3()
{
    ...
    int value;
    CControl Controller;
    Controller.init_com(3); //Makes sure the controller is connected
    do
    {
        ...
        switch (cmd)
        {
        case 1: Controller.analogTest(); break;
        case 2: Controller.digitalTest(); break;
        case 3: Controller.buttonTest(); break;
        case 4: Controller.servoTest(); break;
        }
    } while (cmd != 0);
...
void lab4()
{
    CSnakeGame Snake1(cv::Size(1600, 800), 3);
    Snake1.run(1);
}
...
void lab5()
{
    CSnakeGame Snake2(cv::Size(1600, 800), 3);
    Snake2.run(2);
}
...
void lab6()
{
    CSpaceInvadersGame Invaders(cv::Size(800, 1000), 3);
    Invaders.run(1);
}
